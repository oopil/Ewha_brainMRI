...
nifti_list = os.listdir('SINCHON\\NIFTI')
csv_list = os.listdir('SINCHON\\CSV')
mask_list = os.listdir('SINCHON\\MASKS')
#print(nifti_list)
#print(csv_list)
#print(mask_list)
...
print('T1 CSV :',sub_set(csv_T1, complete_set))
print('T2 CSV :',sub_set(csv_T2, complete_set))
print('T1 mask :',sub_set(new_mask, complete_set))
print('T1 nii :',sub_set(nifti_T1, complete_set))
print('T2 nii :',sub_set(nifti_T2, complete_set))
print('T2 REG :',sub_set(nifti_T2_REG, complete_set))
#print(len(set(csv_T1)&set(csv_T2)&set(new_mask)&set(nifti_T1)&set(nifti_T2)))

# check the absent files 
array = []
a = sub_set(csv_T1, complete_set)
b = sub_set(csv_T2, complete_set)
c = sub_set(new_mask, complete_set)
d = sub_set(nifti_T1, complete_set)
e = sub_set(nifti_T2, complete_set)
f = sub_set(nifti_T2_REG, complete_set)
array = [a,b,c,d,e,f]
print(len(a),len(b))
whole = a | b | c | d | e | f
print(len(whole))
